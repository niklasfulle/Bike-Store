...
/**
 * The StoreService class is responsible for the processing of the data of the
 * Store Entity. It is used to communicate with the database.
 */
@Stateless
public class StoreService {
  ...
  /**
   * Updates Store in the database through the EntityManager. It uses the
   * EntityManagers' find function to fetch the Entity. The store is updated by
   * setting the new values. The EntityManager is flushed to save the changes. If
   * the store is not found, it will not be updated.
   * 
  ...
  /**
   * Removes Store from the database through the EntityManager. It uses the
  ...
  /**
   * Gets the Store from the database through the EntityManager. It uses the
   * EntityManagers' find function to fetch the Entity.
   *
   * @param storeId id of Store
   */
  ...
  /**
   * Receives all stores from the database page and offset needed to calculate the
